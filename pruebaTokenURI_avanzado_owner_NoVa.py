...
my_contract_address = "0x91112e722878AF0e48bF8Ea66994F15c4d5347C6"  # Reemplaza con la dirección de tu contrato ERC721
...
sender_address = "0xe67F18c5064f12470Efc943798236edF45CF3Afb" 


#estimated_gas = contract.functions.mintNFT(name, description, image_url).estimate_gas()
  
nonce = w3.eth.get_transaction_count(wallet.address)    
# Crea una transacción que llama al método mintNFT de tu contrato.
transaction_hash = contract.functions.mintNFT(name, description, image_url).transact({
    'from': "0xe67F18c5064f12470Efc943798236edF45CF3Afb",
    'gas': 7770000,
